class valdaFormulario {
   ...
   senhasSaoValidas() {
      ...
      const repetirSenha = this.formulario.querySelector('.senha-repitida');
   ...
   validaUsuario(campo) {
      ...
      if (usuario.length < 3 || usuario.length > 12) {
         this.criaErro(campo, 'Usuario precisa ter mais de 3 caracteres e menos de 12 caracteres');
         valid = false;
      }
...
const valida = new valdaFormulario();